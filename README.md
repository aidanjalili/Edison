...
## After reading this doc it should take rly only like max 3 hrs to implement smthg like this to the code to make it sustainable For long term use... now only needing periodic 50k transfers out of alpaca to my bank (could prolly set up thru alpaca support or j do it manually every now and again)
